...
const Footer = () => {
    return (
        ...
        <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 fixed bottom-0">
            <div className="items-center">
                <div className='flex justify-between '>
                    <img className='w-14 h-14 p-1 space-x-3 rounded-full  '
                        src={logo} alt="" /> 
                <p className='text-base mt-3'>Nyama Hoard </p> </div>
                <p>An amazing service provider for children happiness since 2023.<br/><br/>
                 <span className='text-black'>Copyright © 2023 - All right reserved by Nyama Hoard Brand.</span></p>
            </div>
            ...
            <div className=" mt-12 relative py-2">
            ...
            <div className="lg:mt-12 md:place-self-center md:justify-self-end">
